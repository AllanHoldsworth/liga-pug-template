...
var _initParallax = require("./modules/init-parallax.js");
var _initMenu = require("./modules/init-menu");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _initParallax.initParallax)();
    (0, _initMenu.initMenu)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/init-menu":9,"./modules/init-parallax.js":10,"./modules/input-file/init-upload":15,"./modules/modals/init-modals":18,"./modules/select/custom-select":21,"./utils/ios-vh-fix":24}],2:[function(require,module,exports){
"use strict";
...
function initMenu() {
  ...
  var previouseTarget = document.querySelector('[data-menu="purple"]');
      ...
      if (previouseTarget === e.target) {
        ...
        menuTimeout = setTimeout(function () {
          ...
          if (!menuTimeline.isActive()) {
            menuTimeline.fromTo('.menu__glass', {
              width: "37.5rem",
              height: "37.5rem"
            }, {
              width: "100vw",
              ...
              attr: {
                src: menuSrc[e.target.dataset.menu]
              }
            }).to('.menu__glass', {
              width: "37.5rem",
              height: "37.5rem",
...
function initParallax() {
  ...
  timeline.to('.layer.layer--top-image img', {
    scale: 5
  ...
  var text = document.querySelectorAll('.layer.layer--glass1 span');
...
},{"./helper":14}],14:[function(require,module,exports){
"use strict";
...
},{"./upload.js":17}],16:[function(require,module,exports){
"use strict";
...
},{"./create-message-markup":11,"./create-preview-container-markup":12,"./create-preview-markup":13,"./render":16}],18:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":26}],20:[function(require,module,exports){
"use strict";
...
},{"../../utils/render":25,"./create-select-markup":20}],22:[function(require,module,exports){
"use strict";
